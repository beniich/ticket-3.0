...
// For Button, I'll rely on global styles or custom button classes since importing Button from ./button might cause circular deps or issues if button isn't perfectly set up.
// Actually, `alert-dialog` usually uses `button` variants. I'll omit button import and use raw styles or button class from standard Shadcn.
